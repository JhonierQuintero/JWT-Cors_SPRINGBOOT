...
async function register(){
    ...
    document.getElementById("regMsg").innerText = res.ok ? "Usuario registrado exitosamente" : "Error al registrar usuario";
}
...
async function login(){
    ...
    if(!res.ok){
        document.getElementById("loginMsg").innerText = "Credencciales incorrectas";
        return;
    }

    localStorage.setItem("jwt", tokenText);
    document.getElementById("loginMsg").innerText = "Inicio de sesion exitoso";
